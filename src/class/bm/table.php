 ...
 *      SUSTC-ShenZhen-B
 *
 *      $Id: class/ei/table.php 2013-06-13 12:25:00 Zhuoteng Peng $
 */
...
class bm_table extends bm_base
{
	...
	public function __construct($para = array()) {
		if(!empty($para)) {
			...
			$this->_pk = $para['pk'];
			if (isset($para['pre_cache_key'])) {
				$this->_pre_cache_key = $para['pre_cache_key'];
			}
		}
